...
sys.path.insert(0, os.path.join(REPO, "scripts", "emulator"))

from benchmark_operator import load_model, predict_all  # noqa: E402
from spexai.operator import FixedGridMLP  # noqa: E402
from spexai.train.train_operator import FLOOR  # noqa: E402
from spexai.data import SpectrumData  # noqa: E402
