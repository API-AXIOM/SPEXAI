...
\paragraph{Next steps.} Two independent tracks. (i) Ship the $11$
good/acceptable elements now: rebuild \code{spexai/models/}
(\code{scripts/collect\_models.py}) and re-validate the joint inference
model, unblocking the multi-instrument science test. (ii) Scope a separate
line-head investigation for the heavy metals (line-head capacity/width and
the deposition accuracy at the $0.1\%$ level), with chromium's continuum
blowup handled alongside via the trunk-capacity levers.
