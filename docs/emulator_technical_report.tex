...
wing masking with a one-sided cap. Results pending at the time of
writing. Independent of its outcome, the hybrid already establishes that
broadening belongs \emph{outside} the network.
...
$1000\kms$ & FFT / hybrid\\
Monolithic $(T,v)$ emulator (v1) & 2.6\% val MRE; $8\times$ worse than
hybrid & hybrid; Gaussian-line v2 pending\\
